...
function initSearch() {
  ...
  request.open('GET', 'http://localhost:4000/mkfont/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', 'http://localhost:4000/mkfont/assets/css/just-the-docs-' + theme + '.css');
}
