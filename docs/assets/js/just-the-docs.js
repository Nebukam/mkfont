...
function initSearch() {
  ...
  request.open('GET', 'https://nebukam.github.io/mkfont/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', 'https://nebukam.github.io/mkfont/assets/css/just-the-docs-' + theme + '.css');
}
